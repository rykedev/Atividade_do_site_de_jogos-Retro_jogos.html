...
Cabeçalho: Logotipo da loja e link direto para o perfil oficial.

Consoles Disponíveis: Lista com plataformas clássicas como Atari 2600, NES, Mega Drive, Super Nintendo, PlayStation 1 e Nintendo 64.
...
.
├── assets/
│   └── retro gamezone (2).png   # Imagem/Logo da loja
├── Retro_jogos.html             # Página principal do projeto
...
Certifique-se de que a imagem retro gamezone (2).png esteja localizada dentro da pasta assets/.
